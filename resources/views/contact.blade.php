...
<body>
    ...
    <div class="row">
        <h1 class="text-center titre2">{{__("message.ct32")}}</h1>
        <p class="fw-bolder text-center"> {{__("message.ct33")}} !</p>
        <p class="fw-bolder text-center">{{__("message.ct34")}} +971-558-57-94-14.</p>
    </div>

    <div class="row justify-content-center mx-auto mt-4 w-50">
        ...
        <form action="" method="">
            ...
            <div class="form-group">
                    <label for="nom" class="fw-bold">{{__("message.ct36")}}</label>
                    <input id="nom" type="text" class="form-control @error('nom') is-invalid @enderror" name="nom" value="{{ old('nom') }}"  autocomplete="nom">
                    @error('nom')
